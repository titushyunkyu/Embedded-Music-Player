...
// RS port register and mask
#define LCD_RS_PIN 13
#define LCD_RS_MASK ((uint32_t) (0x00000001U << LCD_RS_PIN))
#define LCD_RS_PORT GPIOA
#define LCD_RS_INDEX PA13INDEX

// !RST port register and mask
#define LCD_RST_PIN 15
#define LCD_RST_MASK ((uint32_t) (0x00000001U << LCD_RST_PIN))
